	...
	<div class="box">
		<div class="box-content">
			...
			<table class="table_data" width="100%">
				...
				<?php
					$q=mysqli_query($db,"SELECT * FROM users where role = '3' order by id desc");
				...
				<tr>
					...
					<td width="10%"><a class="link" href="index.php?page=siswa&action=view&id=<?=$f[id]?>" title="View">V</a></td>
				</tr>
				<?php
						}
					} else {
