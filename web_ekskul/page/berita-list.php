	...
	<div class="box">
		<div class="box-content">
			...
			<table class="table_data" width="100%">
				...
				<?php
					$q=mysqli_query($db,"SELECT * FROM berita where status = '1' and id_user = '$_SESSION[usr_id]' order by id desc");
					if($_SESSION[role]==2) {
						$q=mysqli_query($db,"SELECT * FROM berita where status = '1' and id_user = '$_SESSION[usr_id]' and id_ekskul='$_SESSION[id_ekskul]' order by id desc");
					}
